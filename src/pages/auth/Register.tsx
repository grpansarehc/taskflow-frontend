      ...
      <div className="w-full max-w-md animate-fade-in">
        <div className="bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-10 shadow-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-white/50 text-[15px]">Join us to get started</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 mt-2 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl text-white font-semibold transition-all hover:translate-y-[-2px] hover:shadow-[0_12px_24px_rgba(99,102,241,0.4)] disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isLoading ? (
