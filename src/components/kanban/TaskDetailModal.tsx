...
import { X, Share2, MoreHorizontal, Lock, GitBranch, GitCommit, ChevronRight, Plus } from 'lucide-react';
                                            ...
                                            subtasks.map((subtask) => (
                                                <div key={subtask.taskId} className="px-4 py-3 flex items-center hover:bg-gray-50 text-sm">
                                                    ...
                                                    <div className="w-20 text-center flex justify-center">
                                                        <div
                                                            className={`w-4 h-0.5 rounded-full ${subtask.priority === 'HIGH' || subtask.priority === 'CRITICAL' ? 'bg-red-500' :
